    ...
    html: function(data) {
        ...
        return `
		  ...
		  <div class="container has-text-centered"> 
              ...
              <a onclick="require('child_process').execSync('start https://www.patreon.com/bePatron?u=8722862')">Like this? Join Patreon!</a>		      <br>The addition or removal of owners requires a bot restart.<br><br>
    ...
    init: function(document, data) {
        ...
        try {
            ...
            document.delOwner = function(element) {
                ...
                document.getElementById(`${owner}_DIV`).parentNode.removeChild(element);
